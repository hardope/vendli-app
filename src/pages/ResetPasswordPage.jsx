...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-5xl grid gap-8 md:grid-cols-[minmax(0,1.1fr)_minmax(460px,1fr)] items-center">
        <div>
          ...
          <p className="mt-4 text-sm sm:text-base text-slate-600 max-w-lg">
        ...
        <div className="relative">
          ...
          <div className="relative rounded-3xl border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.12)]">
            {step === 'request' && (
              <form onSubmit={handleRequestSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-200"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full mt-1 inline-flex items-center justify-center rounded-xl bg-amber-400 text-slate-950 text-sm font-semibold py-3 hover:bg-amber-300 transition-colors disabled:opacity-60"
                >
            ...
            {step === 'code' && (
              <form onSubmit={handleResetSubmit} className="space-y-5">
                <div className="text-xs text-slate-500">
                  <p>Step 2 · Enter code and your new password</p>
                  {form.email && <p className="mt-1 text-slate-400">We sent a code to {form.email}</p>}
                </div>

                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2" htmlFor="email-code-step">
                    Email
                  </label>
                  <input
                    id="email-code-step"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full tracking-[0.3em] text-center rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-200"
                  />
                ...
                <button
                  ...
                  className="w-full mt-2 inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white text-slate-700 text-xs font-medium py-3 hover:bg-slate-50 transition-colors disabled:opacity-60"
                >
